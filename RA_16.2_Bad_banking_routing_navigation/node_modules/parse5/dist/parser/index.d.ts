import { Tokenizer, TokenizerMode, type TokenHandler } from 'parse5/dist/tokenizer/index.js';
import { OpenElementStack, type StackHandlerparse5/dist/parser/open-element-stack.js-stack.js';
import { Formparse5/dist/parser/formatting-element-list.jsformatting-element-list.js';
impparse5/dist/common/error-codes.jsrorHandler } from '../common/error-cparse5/dist/common/html.js
import { TAG_ID as $, NS } from '../common/html.js';parse5/dist/tree-adapters/interface.jster, TreeAdapterTypeMap } from '../tree-adapters/interface.js';
import { type Token, type CommentToken, type CharacterToken, type TagToken, parse5/dist/common/token.js type EOFToken, type LocationWithAttributes } from '../common/token.js';
