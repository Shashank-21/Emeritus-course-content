...
function Withdraw() {
	...
	const handleSubmit = (e) => {
		...
		// Todo: Call the `updateUserBalance` function with the `updatedBalance` as its parameter
		// Set state `showUpdatedBalance` to true
		// Set state `withdrawAmount` to empty string
	};
